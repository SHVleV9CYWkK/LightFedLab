...
#python main.py --fl_method fedwcp --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.0005 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name sgd --n_job 4
