...
# python main.py --fl_method fedem --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.05 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 12
...
# python main.py --fl_method fedavg --dataset_name cifar100 --model lenet --local_epochs 1 --lr 0.005 --batch_size 128 --n_rounds 200 --scheduler_name multi_step --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 4
