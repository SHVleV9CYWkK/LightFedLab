...
#python main.py --fl_method fedavg --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.1 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam
...
#python main.py --fl_method qfedcg --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.01 --server_lr 0.01 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam
# 表现没有上面的好
...
# python main.py --fl_method fedavg --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.05 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name sgd
...
python main.py --fl_method pfedgate --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.1 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name sgd --n_job 2
python main.py --fl_method fedwcp --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.0005 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 2
python main.py --fl_method fedavg --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.1 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 2
python main.py --fl_method fedmask --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.05 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 2
python main.py --fl_method fedcg --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.001 --server_lr 0.001 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 2
python main.py --fl_method qfedcg --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.01 --server_lr 0.01 --batch_size 128 --n_rounds 20 --seed 42 --device cuda --split_method clusters --optimizer_name adam --n_job 2