...
python main.py --fl_method pfedgate --dataset_name emnist --model leafcnn1 --local_epochs 1 --lr 0.1 --batch_size 128 --n_rounds 20 --seed 42 --device cpu --split_method clusters --optimizer_name sgd
